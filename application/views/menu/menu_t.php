    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard active"></i>Menu / Tambah</a></li>
          </ol>
        </section>
          ...
          <div class="box">
            ...
            <div class="box-body" align="center">
              <?php 
                ...
                echo form_open_multipart('menu/tambah',$attributes); ?>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="judul">Nama Menu:</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama" required class="form-control" placeholder="Nama Menu">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="kat" class="form-control" required>
                      <?php foreach ($r_kat as $rk) { ?>
                        <option value="<?php echo $rk['id_kat'] ?>"><?php echo $rk['nama_kat'] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="desk" class="form-control" placeholder="Deskripsi"></textarea>
                  </div>
                </div>
                <div class="form-group">
