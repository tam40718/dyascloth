    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard active"></i>User / Tambah</a></li>
          </ol>
        </section>
          ...
          <div class="box">
            ...
            <div class="box-body" align="center">
              <?php 
                ...
                echo form_open_multipart('user/tambah',$attributes); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="akses" class="form-control" required>
                      <?php foreach ($r_akses as $rk) { if ($rk['id_akses']!=4) { ?>
                        <option value="<?php echo $rk['id_akses'] ?>"><?php echo $rk['nama'] ?></option>
                      <?php }} ?>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="ktp" maxlength="16" required class="form-control" placeholder="Nomor KTP">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="judul">Nomor Telepon:</label>
                  <div class="col-sm-10">
                    <input type="text" name="telpon" maxlength="12" required class="form-control" placeholder="Nomor Telepon">
                  </div>
                </div>
                <div class="form-group">
